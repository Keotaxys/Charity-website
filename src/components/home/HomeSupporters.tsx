  ...
  return (
    <section className="bg-white py-24 px-6 border-t border-gray-100">
      <div className="max-w-7xl mx-auto text-center">
        <h2 className="text-3xl md:text-5xl font-black text-gray-900 tracking-tight mb-4">{locale === 'lo' ? 'ຂໍຂອບໃຈຜູ້ສະໜັບສະໜູນຫຼັກ' : 'OUR INCREDIBLE SUPPORTERS'}</h2>
        <p className="text-gray-500 text-lg max-w-2xl mx-auto mb-16">{locale === 'lo' ? 'ທຸກໂຄງການຂອງພວກເຮົາຈະເກີດຂຶ້ນບໍ່ໄດ້ເລີຍ ຖ້າປາສະຈາກການຊ່ວຍເຫຼືອຈາກພາກສ່ວນເຫຼົ່ານີ້.' : 'Our missions are made possible through the generous support of our partners.'}</p>
