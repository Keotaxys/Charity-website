    ...
    <footer className="bg-white pt-16 pb-10 px-6 mt-auto border-t border-gray-100">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row justify-between items-center gap-8 mb-10">
          ...
          <div className="flex flex-wrap justify-center lg:justify-start items-center gap-3 md:gap-5 text-sm font-bold text-gray-500 uppercase tracking-wider">
          ...
          <div className="flex items-center gap-3">
            {contact.instagram_url && (
              <a href={contact.instagram_url} target="_blank" className="w-12 h-12 bg-pink-300 hover:bg-teal-600 text-gray-900 hover:text-white rounded-full flex items-center justify-center transition-all transform hover:scale-110">
            ...
            {contact.facebook_url && (
              <a href={contact.facebook_url} target="_blank" className="w-12 h-12 bg-pink-300 hover:bg-teal-600 text-gray-900 hover:text-white rounded-full flex items-center justify-center transition-all transform hover:scale-110">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"/></svg>
              </a>
            )}
            {contact.youtube_url && (
              <a href={contact.youtube_url} target="_blank" className="w-12 h-12 bg-pink-300 hover:bg-teal-600 text-gray-900 hover:text-white rounded-full flex items-center justify-center transition-all transform hover:scale-110">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z"/></svg>
              </a>
            )}
            {contact.tiktok_url && (
              <a href={contact.tiktok_url} target="_blank" className="w-12 h-12 bg-pink-300 hover:bg-teal-600 text-gray-900 hover:text-white rounded-full flex items-center justify-center transition-all transform hover:scale-110">
