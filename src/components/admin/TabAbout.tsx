  ...
  return (
    <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 animate-fade-in-up">
      <div className="flex items-center gap-3 mb-8 border-b border-gray-100 pb-6">
        ...
        <div>
          <h2 className="text-2xl font-black text-gray-900">ຕັ້ງຄ່າໜ້າ "ກ່ຽວກັບພວກເຮົາ"</h2>
          <p className="text-gray-500 text-sm mt-1">ແກ້ໄຂຂໍ້ມູນທຸກພາກສ່ວນທີ່ສະແດງໃນໜ້າ /about</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSave} className="space-y-10">
        ...
        <div className="p-8 bg-gray-50 rounded-[2rem] border border-gray-200 shadow-sm relative overflow-hidden">
          ...
          <h3 className="text-xl font-black text-gray-900 mb-6 flex items-center gap-2">
            1️⃣ ໝວດ: ກ່ຽວກັບພວກເຮົາ <span className="text-sm font-medium text-gray-500 ml-2">(ໜ້າປົກ ແລະ ສ່ວນຊັກຊວນ)</span>
          </h3>
          
          {/* ສ່ວນໜ້າປົກ (Hero) */}
          <div className="space-y-4 mb-8">
            <h4 className="font-bold text-teal-700 bg-teal-50 px-3 py-1 inline-block rounded-lg text-sm">» ຂໍ້ຄວາມໜ້າປົກ (ດ້ານເທິງສຸດ)</h4>
          ...
          <div className="space-y-4 pt-6 border-t border-gray-200">
            <h4 className="font-bold text-pink-600 bg-pink-50 px-3 py-1 inline-block rounded-lg text-sm">» ຂໍ້ຄວາມຊັກຊວນ (ດ້ານລຸ່ມສຸດ)</h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-gray-700 font-bold mb-2 text-sm">ຫົວຂໍ້ຊັກຊວນ (ລາວ)</label>
              ...
              <div>
                <label className="block text-gray-700 font-bold mb-2 text-sm">ຫົວຂໍ້ຊັກຊວນ (ອັງກິດ)</label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-gray-700 font-bold mb-2 text-sm">ຂໍ້ຄວາມຊັກຊວນ (ລາວ)</label>
              ...
              <div>
                <label className="block text-gray-700 font-bold mb-2 text-sm">ຂໍ້ຄວາມຊັກຊວນ (ອັງກິດ)</label>
        ...
        <div className="p-8 bg-gray-50 rounded-[2rem] border border-gray-200 shadow-sm relative overflow-hidden">
          ...
          <h3 className="text-xl font-black text-gray-900 mb-6 flex items-center gap-2">
            2️⃣ ໝວດ: ຈຸດເລີ່ມຕົ້ນຂອງພວກເຮົາ <span className="text-sm font-medium text-gray-500 ml-2">(ເນື້ອຫາປະຫວັດ ແລະ ຮູບພາບ)</span>
          </h3>
          ...
          <div className="mt-6">
            ...
            <input type="url" name="story_image" required className="w-full p-4 bg-white border border-gray-200 rounded-xl outline-none focus:ring-2 focus:ring-pink-500 text-gray-900 font-medium" placeholder="ວາງລິ້ງຮູບພາບທີ່ນີ້..." value={settings.story_image} onChange={handleChange} />
          </div>
        </div>
        ...
        <div className="p-8 bg-gray-50 rounded-[2rem] border border-gray-200 shadow-sm relative overflow-hidden">
          ...
          <h3 className="text-xl font-black text-gray-900 mb-6 flex items-center gap-2">
            3️⃣ ໝວດ: ຫຼັກການເຮັດວຽກຂອງພວກເຮົາ <span className="text-sm font-medium text-gray-500 ml-2">(3 ກາດ)</span>
          </h3>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 border-b border-gray-200 pb-6">
            <div>
              <label className="block text-gray-700 font-bold mb-2 text-sm">ຫົວຂໍ້ພາກສ່ວນນີ້ (ລາວ)</label>
            ...
            <div>
              <label className="block text-gray-700 font-bold mb-2 text-sm">ຫົວຂໍ້ພາກສ່ວນນີ້ (ອັງກິດ)</label>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-sm">
              ...
              <h4 className="font-black text-gray-900 mb-4 text-lg">ກາດທີ 1: ຄວາມໂປ່ງໃສ</h4>
              <div className="space-y-4">
                <input type="text" name="v1_title_lo" placeholder="ຫົວຂໍ້ (ລາວ)" className="w-full p-3 bg-gray-50 border border-gray-200 rounded-lg outline-none text-gray-900 font-medium text-sm" value={settings.v1_title_lo} onChange={handleChange} />
                <input type="text" name="v1_title_en" placeholder="ຫົວຂໍ້ (ອັງກິດ)" className="w-full p-3 bg-gray-50 border border-gray-200 rounded-lg outline-none text-gray-900 font-medium text-sm" value={settings.v1_title_en} onChange={handleChange} />
                <textarea name="v1_desc_lo" placeholder="ລາຍລະອຽດ (ລາວ)" rows={3} className="w-full p-3 bg-gray-50 border border-gray-200 rounded-lg outline-none text-gray-900 font-medium text-sm resize-none" value={settings.v1_desc_lo} onChange={handleChange}></textarea>
                <textarea name="v1_desc_en" placeholder="ລາຍລະອຽດ (ອັງກິດ)" rows={3} className="w-full p-3 bg-gray-50 border border-gray-200 rounded-lg outline-none text-gray-900 font-medium text-sm resize-none" value={settings.v1_desc_en} onChange={handleChange}></textarea>
              </div>
            </div>
            ...
            <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-sm">
              ...
              <h4 className="font-black text-gray-900 mb-4 text-lg">ກາດທີ 2: ຄວາມເມດຕາ</h4>
              <div className="space-y-4">
                <input type="text" name="v2_title_lo" placeholder="ຫົວຂໍ້ (ລາວ)" className="w-full p-3 bg-gray-50 border border-gray-200 rounded-lg outline-none text-gray-900 font-medium text-sm" value={settings.v2_title_lo} onChange={handleChange} />
                <input type="text" name="v2_title_en" placeholder="ຫົວຂໍ້ (ອັງກິດ)" className="w-full p-3 bg-gray-50 border border-gray-200 rounded-lg outline-none text-gray-900 font-medium text-sm" value={settings.v2_title_en} onChange={handleChange} />
                <textarea name="v2_desc_lo" placeholder="ລາຍລະອຽດ (ລາວ)" rows={3} className="w-full p-3 bg-gray-50 border border-gray-200 rounded-lg outline-none text-gray-900 font-medium text-sm resize-none" value={settings.v2_desc_lo} onChange={handleChange}></textarea>
                <textarea name="v2_desc_en" placeholder="ລາຍລະອຽດ (ອັງກິດ)" rows={3} className="w-full p-3 bg-gray-50 border border-gray-200 rounded-lg outline-none text-gray-900 font-medium text-sm resize-none" value={settings.v2_desc_en} onChange={handleChange}></textarea>
              </div>
            </div>
            ...
            <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-sm">
              ...
              <h4 className="font-black text-gray-900 mb-4 text-lg">ກາດທີ 3: ການລົງມືເຮັດຈິງ</h4>
              <div className="space-y-4">
                <input type="text" name="v3_title_lo" placeholder="ຫົວຂໍ້ (ລາວ)" className="w-full p-3 bg-gray-50 border border-gray-200 rounded-lg outline-none text-gray-900 font-medium text-sm" value={settings.v3_title_lo} onChange={handleChange} />
                <input type="text" name="v3_title_en" placeholder="ຫົວຂໍ້ (ອັງກິດ)" className="w-full p-3 bg-gray-50 border border-gray-200 rounded-lg outline-none text-gray-900 font-medium text-sm" value={settings.v3_title_en} onChange={handleChange} />
                <textarea name="v3_desc_lo" placeholder="ລາຍລະອຽດ (ລາວ)" rows={3} className="w-full p-3 bg-gray-50 border border-gray-200 rounded-lg outline-none text-gray-900 font-medium text-sm resize-none" value={settings.v3_desc_lo} onChange={handleChange}></textarea>
                <textarea name="v3_desc_en" placeholder="ລາຍລະອຽດ (ອັງກິດ)" rows={3} className="w-full p-3 bg-gray-50 border border-gray-200 rounded-lg outline-none text-gray-900 font-medium text-sm resize-none" value={settings.v3_desc_en} onChange={handleChange}></textarea>
              </div>
            </div>
          </div>
        </div>
