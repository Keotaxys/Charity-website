...
import AdminGuard from '@/components/AdminGuard'; // 👈 ດຶງ AdminGuard ເຂົ້າມາໃຊ້ງານ
...
export default function AdminDashboard() {
  ...
  return (
    // 👈 ຫຸ້ມເນື້ອຫາທັງໝົດດ້ວຍ AdminGuard ເພື່ອປ້ອງກັນການເຂົ້າເຖິງ ແລະ ປ້ອງກັນການເດັ້ງອອກ
    <AdminGuard>
          ...
          <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
            ...
            <form onSubmit={handleSaveVideo} className="flex gap-4">
              ...
              <button 
                ...
                className="bg-gray-900 hover:bg-teal-600 text-white font-bold py-4 px-8 rounded-xl transition-all disabled:bg-gray-400 whitespace-nowrap"
              >
